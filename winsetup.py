...
class WinSetup(tk.Tk):
    ...
    def button_row(self, parent, label, desc, command):
        ...
        info.pack(side="left", fill="both", expand=True, padx=18, pady=18)
        tk.Label(info, text=label, font=("Consolas", 13, "bold"), bg=SURFACE, fg=TEXT, anchor="w").pack(anchor="w", pady=(4,2))
        tk.Label(info, text=desc, font=("Consolas", 10), bg=SURFACE, fg=TEXT2, anchor="w", wraplength=480).pack(anchor="w", pady=(0,4))
